...
public class FISController {
	...
	@HystrixCommand(fallbackMethod = "fallbackMethodTestFISSleep")
	public String testFISSleep() throws Exception {
		int pt = setProcTimeBean.calculateProcessingTime();
        logger.info("/recommendation called, processing time: {}", pt);
	...
	public String fallbackMethodTestFISSleep() {
		return "Inside fallbackMethodTestFISSleep";
	}
